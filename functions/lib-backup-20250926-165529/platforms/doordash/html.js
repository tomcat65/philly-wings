  ...
  if (!combos?.length) {
    ...
    <section id="combos" class="menu-section">
        <div class="section-header">
            ...
            <p class="section-description">Combos section temporarily unavailable - data loading</p>
        </div>
    </section>`;
  }
...
function generateWingsSection(wings, branding) {
  if (!wings || !wings.variants || wings.variants.length === 0) {
    return `
    <section id="wings" class="menu-section">
        <div class="section-header">
            <h2 class="section-title">🍗 Wings</h2>
            <p class="section-description">Wings section temporarily unavailable - data loading</p>
        </div>
    </section>`;
  }
  ...
  if (!beverages || beverages.length === 0) {
    ...
    <section id="beverages" class="menu-section">
        <div class="section-header">
            ...
            <p class="section-description">Beverages section temporarily unavailable - data loading</p>
        </div>
    </section>`;
  }
...
function generateSaucesSection(sauces, branding) {
  if (!sauces || sauces.length === 0) {
    ...
    <section id="sauces" class="menu-section">
        <div class="section-header">
            <h2 class="section-title">🌶️ Sauces</h2>
            <p class="section-description">Sauces section temporarily unavailable - data loading</p>
        </div>
    </section>`;
  }

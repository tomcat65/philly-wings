...
/**
 * Test Data Seeder for Firebase Emulators
 *
 * Seeds all collections with test data for local development
 */
...
const COMBOS = [
  {
    ...
    images: {
      hero: 'https://firebasestorage.googleapis.com/v0/b/philly-wings.firebasestorage.app/o/images%2Fgame-day-30-wings.png?alt=media'
    }
  },
  {
    id: 'the_tailgater',
...
async function seedTestUser() {
  console.log('👤 Note: Create test user in Auth emulator manually:');
  console.log('   Email: admin@phillywingsexpress.com');
  console.log('   Password: admin2025');
  console.log('   Access: http://localhost:4000/auth');
}
